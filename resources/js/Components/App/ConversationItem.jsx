...
const ConversationItem = ({
    ...
    if(selectConversation) {
        if(!selectConversation.is_group && !conversation.is_group && selectConversation.id == conversation.id) {
    ...
    return <Link
            ...
            preserveState
            className={"conversation-item flex items-center gap-2 p-2 text-gray-300 transition-all cursor-pointer border-l-5 hover:bg-black/30"
